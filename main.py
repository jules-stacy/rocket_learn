...
if __name__ == '__main__':
    ...
    num_procs = 1
    num_ts = 1_000_000
    env = SB3VecMonitor(SB3MultipleInstanceWrapper(epic_path, num_procs, get_match_args, wait_time=25),
                        filename=monitor_path)

    # env = Monitor(rlgym.make("Duel", spawn_opponents=True, team_size=1, ep_len_minutes=1,
    #                 obs_builderul=obs_builder, terminal_conditions=[term_cond1], reward_fn=all_rewards, game_speed=1))
    ...
    # learner = PPO.load(path='C:\\Users\\jules\\Documents\\SMU\\code2\\PPO2\\ppo_bot__250006500_steps',
    #                    env=env,
    #                    device='cuda',
    #                    n_epochs=1,
    #                    target_kl=0.02 / 1.5,
