...
def eval_policy(policy, env_name, spawn_opponents, team_size, ep_len_minutes, eval_episodes=10):
    eval_env = rlgym.make(env_name, spawn_opponents, team_size, ep_len_minutes)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default="Duel")                    # RLgym environment name (Custom, Duel, Doubles, Standard, Basic)
    ...
    replay_buffer = agent_utils.ReplayBuffer(state_dim, action_dim)

    # Evaluate untrained policy
    # evaluations = [eval_policy(policy, env_name=args.env, spawn_opponents=args.opponents, team_size=args.team_size, ep_len_minutes=args.ep_len)]
