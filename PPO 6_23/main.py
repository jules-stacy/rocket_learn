...
if __name__ == '__main__':
    ...
    monitor_path = 'C:\\Users\\Daanesh\\PycharmProjects\\RocketLeagueRL\\Reward_Details'
    num_procs = 6
    num_ts = 50_000_000
    env = SB3VecMonitor(SB3MultipleInstanceWrapper(epic_path, num_procs, get_match_args, wait_time=35),
    ...
    checkpoint = CheckpointCallback(save_freq=1_000_000 // env.num_envs + 1,
                                    save_path='C:\\Users\\Daanesh\\PycharmProjects\\RocketLeagueRL\\PPO3\\',
                                    name_prefix="ppo_bot_",
                                    verbose=1)

    #learner = PPO("MlpPolicy", env, verbose=3, device='cuda', n_epochs=1, target_kl=0.02 / 1.5)
    learner = PPO.load(path='C:\\Users\\Daanesh\\PycharmProjects\\RocketLeagueRL\\PPO2\\ppo_bot__33000264_steps',
                       env=env,
                       device='cuda',
                       n_epochs=1,
                       target_kl=0.02 / 1.5,
    ...
    # learner.save('C:\\Users\\Daanesh\\PycharmProjects\\RocketLeagueRL\\PPO3\\ppo3_bot_RewardIfBehindBall_')
